> This project was generated from the [avy-erp React Native Template](https://github.com/avy-erp/react-native-template-avy-erp), a production-ready React Native starter with modern tooling and best practices.
