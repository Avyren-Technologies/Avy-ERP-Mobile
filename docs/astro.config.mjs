...
const site = 'https://starter.avy-erp.com/';

// https://astro.build/config
export default defineConfig({
  site: 'https://starter.avy-erp.com/',
  integrations: [
    starlight({
      title: 'avy-erp Starter | React Native Template',
      ...
      social: [
        { icon: 'github', label: 'GitHub', href: 'https://github.com/avy-erp/react-native-template-avy-erp' },
      ],
      head: [
        {
          tag: 'meta',
