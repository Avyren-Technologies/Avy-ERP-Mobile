...
description: Let's create a new React native project with avy-erp starter.
head:
  - tag: title
    content: Create a new App | React Native / Expo Starter
---

Let's create a new React Native project with avy-erp starter.
...
Start your project using `create-avy-erp-app` command:
