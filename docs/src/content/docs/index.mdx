---
title: avy-erp Starter | React Native/Expo starter
...
hero:
  ...
  actions:
    - text: Get Started
      ...
      variant: primary
    - text: Hire Us
      link: https://avy-erp.com/contact?utm_source=starter.avy-erp.com
      icon: external
      variant: secondary
---
...
[Hire Us](https://avy-erp.com/contact?utm_source=starter.avy-erp.com)
