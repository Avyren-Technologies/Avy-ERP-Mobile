...
describe('button component ', () => {
  ...
  it('should apply correct styles based on size prop', () => {
    ...
    const expectedStyle
      = 'font-inter font-semibold text-white dark:text-black dark:text-white text-xl';
    const receivedStyle
  ...
  it('should apply correct styles for label when is disabled', () => {
    ...
    const expectedStyle
      = 'font-inter font-semibold text-base text-neutral-600 dark:text-neutral-600 dark:text-neutral-400';
    const receivedStyle
      = button.props.children[0].props.children.props.className;
    expect(receivedStyle).toContain(expectedStyle);
  });
