    ...
    return (
        <View style={styles.fieldWrap}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
                <Text className="font-inter text-xs font-bold text-primary-900">{label}</Text>
            ...
            <View style={{ flex: 1, backgroundColor: 'rgba(8, 15, 40, 0.32)' }}>
                ...
                <View style={[styles.fullFormSheet, { paddingBottom: insets.bottom + 20, marginTop: insets.top + 20 }]}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled" style={{ flex: 1 }}>
                        ...
                        <View style={styles.fieldWrap}>
                            <Text className="mb-1.5 font-inter text-xs font-bold text-primary-900">Cycle Name <Text className="text-danger-500">*</Text></Text>
                        ...
                        <View style={{ flexDirection: 'row', gap: 12 }}>
                            <View style={[styles.fieldWrap, { flex: 1 }]}>
                                <Text className="mb-1.5 font-inter text-xs font-bold text-primary-900">Start Date <Text className="text-danger-500">*</Text></Text>
                            ...
                            <View style={[styles.fieldWrap, { flex: 1 }]}>
                                <Text className="mb-1.5 font-inter text-xs font-bold text-primary-900">End Date <Text className="text-danger-500">*</Text></Text>
                        ...
                        <View style={styles.fieldWrap}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                                <Text className="font-inter text-xs font-bold text-primary-900">Competency Weightage</Text>
                            ...
                            <View style={styles.bellCurveWrap}>
                                {form.bellCurveDistribution.map((item, idx) => (
                                    <View key={idx} style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                                        <Text className="font-inter text-xs text-neutral-600" style={{ flex: 1 }}>{item.label}</Text>
        ...
        <Animated.View entering={FadeInUp.duration(350).delay(100 + index * 60)}>
            <Pressable onPress={onEdit} style={({ pressed }) => [styles.card, pressed && styles.cardPressed]}>
                ...
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 8, flexWrap: 'wrap' }}>
                    ...
                    <Text className="font-inter text-xs text-neutral-500">{item.entriesCount} entries</Text>
                </View>
...
export function AppraisalCyclesScreen() {
    ...
    const renderHeader = () => (
        <Animated.View entering={FadeInDown.duration(400)} style={styles.headerContent}>
            <Text className="font-inter text-2xl font-bold text-primary-950">Appraisal Cycles</Text>
            <Text className="mt-1 font-inter text-sm text-neutral-500">{cycles.length} cycle{cycles.length !== 1 ? 's' : ''}</Text>
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.headerBar}>
                ...
                <Text className="flex-1 text-center font-inter text-base font-bold text-primary-950">Appraisal Cycles</Text>
                <View style={{ width: 36 }} />
            </View>
            <FlatList
...
const styles = StyleSheet.create({
    ...
    scaleBadge: { backgroundColor: colors.primary[50], borderRadius: 6, paddingHorizontal: 8, paddingVertical: 3 },
    ...
    bellCurveWrap: { backgroundColor: colors.neutral[50], borderRadius: 14, padding: 12, marginBottom: 14, borderWidth: 1, borderColor: colors.neutral[200] },
    ...
    sliderBtn: { paddingHorizontal: 12, paddingVertical: 4, borderRadius: 8, backgroundColor: colors.primary[50] },
