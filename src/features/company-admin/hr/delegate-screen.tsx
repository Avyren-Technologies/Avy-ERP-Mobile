        ...
        <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
            <View style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(8, 15, 40, 0.32)' }}>
                ...
                <View style={[styles.formSheet, { paddingBottom: insets.bottom + 20, maxHeight: '85%' }]}>
                    <View style={styles.sheetHandle} />
                    <Text className="font-inter text-lg font-bold text-primary-950 mb-4">Add Delegation</Text>
                    <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
                        ...
                        <View style={styles.fieldWrap}>
                            <Text className="mb-1.5 font-inter text-xs font-bold text-primary-900">Reason (optional)</Text>
        ...
        <Animated.View entering={FadeInUp.duration(350).delay(100 + index * 60)}>
            <View style={styles.card}>
                <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10 }}>
                    ...
                    <View style={{ flex: 1 }}>
                        <Text className="font-inter text-xs font-bold text-primary-950">{item.managerName}</Text>
                ...
                <View style={styles.dateRow}>
                    <View style={styles.dateChip}>
                        ...
                        <Text className="font-inter text-xs text-neutral-600">{formatDate(item.fromDate)} - {formatDate(item.toDate)}</Text>
                    </View>
...
export function DelegateScreen() {
    ...
    const renderHeader = () => (
        <Animated.View entering={FadeInDown.duration(400)} style={styles.headerContent}>
            <Text className="font-inter text-2xl font-bold text-primary-950">Manager Delegation</Text>
            <Text className="mt-1 font-inter text-sm text-neutral-500">{items.length} delegation{items.length !== 1 ? 's' : ''}</Text>
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.headerBar}>
                ...
                <Text className="flex-1 text-center font-inter text-base font-bold text-primary-950">Manager Delegation</Text>
                <View style={{ width: 36 }} />
            </View>
