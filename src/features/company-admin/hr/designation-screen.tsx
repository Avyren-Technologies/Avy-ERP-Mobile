...
function DesignationFormModal({
    ...
    const handleSave = () => {
        ...
        onSave({
            ...
            probationDays: parseInt(probationDays, 10) || 0, status,
        });
    };
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.headerBar}>
                ...
                <Text className="flex-1 text-center font-inter text-base font-bold text-primary-950">Designation Management</Text>
                <View style={{ width: 36 }} />
            </View>
