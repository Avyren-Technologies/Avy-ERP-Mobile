...
import { useGrievanceCategories, useGrievanceCases } from '@/features/company-admin/api/use-recruitment-queries';
import {
    ...
    return (
        <View style={[styles.container, { paddingTop: insets.top }]}>
            ...
            <View style={styles.headerBar}>
                ...
                <Text className="flex-1 text-center font-inter text-base font-bold text-primary-950">Grievances</Text>
                <View style={{ width: 36 }} />
            </View>
            <FlatList
