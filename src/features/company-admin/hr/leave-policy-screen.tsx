                ...
                {options.map(opt => {
                    ...
                    return (
                        <Pressable key={opt} onPress={() => onSelect(opt)} style={[styles.chip, selected && styles.chipActive]}>
                            <Text className={`font-inter text-xs font-semibold ${selected ? 'text-white' : 'text-neutral-600'}`}>{LEVEL_LABELS[opt as AssignmentLevel]?.toUpperCase() || opt.toUpperCase()}</Text>
                        </Pressable>
                    );
                })}
            </View>
            ...
            >
                <View style={{ flex: 1, justifyContent: 'flex-end', backgroundColor: 'rgba(8, 15, 40, 0.32)' }}>
                    ...
                    <View style={[styles.formSheet, { paddingBottom: Math.max(insets.bottom, 20) }]}>
                        <View style={styles.sheetHandle} />
                        <Text className="font-inter text-lg font-bold text-primary-950 mb-4 uppercase tracking-tighter">
                        ...
                        >
                            ...
                            <View style={styles.fieldWrap}>
                                <Text className="mb-1.5 font-inter text-xs font-bold text-primary-900 uppercase">Annual Entitlement</Text>
                            ...
                            <View style={styles.fieldWrap}>
                                <Text className="mb-1.5 font-inter text-xs font-bold text-primary-900 uppercase">Carry Forward Days</Text>
                                <View style={styles.inputWrap}>
...
const styles = StyleSheet.create({
    ...
    inputWrap: { backgroundColor: colors.neutral[50], borderRadius: 14, borderWidth: 1, borderColor: colors.neutral[200], paddingHorizontal: 14, height: 50, justifyContent: 'center' },
    textInput: { fontFamily: 'Inter', fontSize: 14, color: colors.primary[950], fontWeight: '600' },
    dropdownBtn: {
        backgroundColor: colors.neutral[50], borderRadius: 14, borderWidth: 1, borderColor: colors.neutral[200],
